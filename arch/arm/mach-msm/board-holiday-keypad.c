...
static void holiday_gpio_event_input_init(void)
{
...
static int holiday_gpio_keypad_power(
...
static struct gpio_event_platform_data holiday_keypad_data = {
	...
	.power = holiday_gpio_keypad_power,
};
...
void __init htc8x60_init_keypad(void)
{
	...
	holiday_gpio_event_input_init();
	platform_device_register(&holiday_keypad_input_device);
}
